...
from brassboard_seq.rfsoc_backend import Jaqal_v1_3, Jaqalv1_3StreamGenerator, RFSOCBackend
...
class CompilerTester:
    def __init__(self):
        self.gen = Jaqalv1_3StreamGenerator()
    ...
    def get_output(self):
        ...
        for board_id in range(4):
            ...
            for inst in Jaqal_v1_3.extract_pulses(prefix + sequence):
                d = inst.to_dict()
