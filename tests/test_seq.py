...
"""
    ...
    assert str(t2) == f'T[1] + (1.0 ms; if bool({v2}))'
...
"""
    ...
    assert str(t4) == f'T[3] + (200.0 us; if {bv1})'
...
"""
    ...
    assert str(t5) == 'T[4] + (1.0 s; if False)'
...
"""
    ...
    assert str(t11) == f'T[6] + (200.0 ms; if {bv1})'
    f1 = StaticFunction()
...
"""
    ...
    assert str(t12) == f'T[11] + (10.0 s; if {bv1})'
    assert str(s) == f"""Seq - T[11]
 T[0]: 0.0 ps
 T[1]: {t1}
 T[2]: {t2}
...
"""
    ...
    assert str(t15) == f'T[14] + (120.0 ms; if {bv1})'
    assert str(s) == f"""Seq - T[11]
 T[0]: 0.0 ps
 T[1]: {t1}
 T[2]: {t2}
...
"""
    ...
    assert str(t19) == f'T[18] + (200.0 ms; if {bv1})'
    assert str(s) == f"""Seq - T[16]
 T[0]: 0.0 ps
 T[1]: {t1}
 T[2]: {t2}
...
"""
 ...
 T[24]: {t24}"""
  ...
  SubSeq@T[21] - T[24]
    ...
    assert str(t25) == f'T[16] + (100.0 ms; if {bv1})'
    assert str(s) == f"""Seq - T[25]
{s_t1_24}
 T[25]: {t25}
 T[26]: T[16] + (200.0 ms; if {bv1})
{s_st1_12}
...
"""
    ...
    assert str(t28) == f'T[27] + (200.0 ms; if {bv1} & bool({v2}))'
    assert str(s) == f"""Seq - T[25]
{s_t1_24}
 T[25]: {t25}
 T[26]: T[16] + (200.0 ms; if {bv1})
...
"""
    ...
    assert str(t34) == 'T[25]; wait_for(T[28] + 10.0 ms)'
...
"""
    ...
    assert str(t35) == f'T[34]; wait_for(T[33] + 0.0 ps; if {bv1})'
