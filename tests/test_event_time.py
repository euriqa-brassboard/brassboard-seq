...
def test_event_time1():
    ...
    t5 = test_utils.time_manager_new_round_time(mgr, t4, 3e-9, False, None)
...
def test_event_time3():
    ...
    t1 = test_utils.time_manager_new_round_time(mgr, t0, 0.01, True, None)
